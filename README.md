...
- aktuelle 1.0-Version: `1.0`
- aktuelle stabile Version: `latest`

Für produktive Installationen ist ein fester Versions-Tag wie `1.0.0` weiterhin die sicherste Wahl.
...
- GitHub Container Registry: `ghcr.io/railsimulatornet/autoheal`
- fixed release: `1.0.0`
- current 1.0 release: `1.0`
- current stable release: `latest`

A fixed version tag such as `1.0.0` remains the safest choice for production deployments.
